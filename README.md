# multi-nib-pen
🖋️ 3-in-1 Multi-Nib Pen Simulation

An interactive 3D visualization of a multi-nib pen mechanism. Toggle between external and internal views, rotate the selector, and test the ink!
